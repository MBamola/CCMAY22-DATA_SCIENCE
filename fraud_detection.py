...
Original file is located at
    https://colab.research.google.com/drive/1QQPbvf9jitptDM7GlQOqTH3iLK1Khfux

###**AIM**

With the increasing technologies transaction of money has become lot easier but with pros comes con. Multiple crimes occur every minute related to fraud. To overcome this issue machine learning approach has been introduced to predict what precautions can be taken to prevent these frauds and which activites can raise new fraud activities based on hidden insights of previous tactics.

The dataset used for this study is taken from public repository kaggle. The link to dataset is:  (https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud)
...
""">logistic regressor has achieved an accuray of 94% which shows it is good classifier for this purpose. Moreover precision and recall suggest that it classifies positive and negative classes accurately.
...
""">k-neighbor has achieved an accuray of 99% which shows it is the best classifier which can be taken into consideration for this problem. Moreover precision and recall suggest that it classifies positive and negative classes accurately.
...
""">svc has achieved an accuray of 94% which shows it is good classifier for this purpose. Moreover precision and recall suggest that it classifies positive and negative classes accurately.
...
>After experimenting with 3 different machine learning models, it is seen that KNN comes up with highest accuracy. Logistic regression and Support Vector classifiers are almost on same level of prediction. KNN can be taken into practice for classifying real and fake transcations.
"""
